...
export class MediaComponent implements OnInit {
  ...
  onDownloadClick(mediaId: string) {
    this.store.dispatch([new CreateTask(mediaId, Type.DOWNLOAD_MEDIA), new SetMediaStatus(mediaId, 'SCHEDULED_DOWNLOAD')])
  }

  onDeleteClick(mediaId: string) {
    this.store.dispatch([new CreateTask(mediaId, Type.DELETE_FILE), new SetMediaStatus(mediaId, 'SCHEDULED_DELETE')])
  }
